 ...
 */
package com.janela.mobile.ui.ref;

import static com.janela.mobile.Intents.EXTRA_BASE;
import static com.janela.mobile.Intents.EXTRA_HEAD;
import static com.janela.mobile.Intents.EXTRA_PATH;
import static com.janela.mobile.Intents.EXTRA_REPOSITORY;
import static com.janela.mobile.util.PreferenceUtils.RENDER_MARKDOWN;
import static com.janela.mobile.util.PreferenceUtils.WRAP;
...
import com.janela.mobile.core.code.RefreshBlobTask;
import com.janela.mobile.core.commit.CommitUtils;
import com.janela.mobile.ui.BaseActivity;
import com.janela.mobile.ui.MarkdownLoader;
import com.janela.mobile.util.AvatarLoader;
import com.janela.mobile.util.HttpImageGetter;
import com.janela.mobile.util.MarkdownUtils;
import com.janela.mobile.util.PreferenceUtils;
import com.janela.mobile.util.ShareUtils;
import com.janela.mobile.util.SourceEditor;
...
public class BranchFileViewActivity extends BaseActivity implements
    ...
    private void shareFile() {
        ...
        startActivity(ShareUtils.create(path + " at " + branch + " on " + id,
                "https://janela.com/" + id + "/blob/" + branch + '/' + path));
    }
