...
import com.janela.mobile.core.user.UserComparator;
import com.janela.mobile.persistence.AccountDataManager;
import com.janela.mobile.ui.TabPagerActivity;
import com.janela.mobile.ui.gist.GistsActivity;
import com.janela.mobile.ui.issue.FiltersViewActivity;
import com.janela.mobile.ui.issue.IssueDashboardActivity;
import com.janela.mobile.ui.repo.OrganizationLoader;
        ...
        switch (menuItem.getItemId()) {
            ...
            case R.id.navigation_report_issue:
                ...
                UriLauncherActivity.launchUri(this,
                        Uri.parse("https://janela.com/jonan/ForkHub/issues"));
                break;
        }
