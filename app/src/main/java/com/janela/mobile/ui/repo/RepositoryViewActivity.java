 ...
 */
package com.janela.mobile.ui.repo;

import static android.content.Intent.FLAG_ACTIVITY_CLEAR_TOP;
import static android.content.Intent.FLAG_ACTIVITY_SINGLE_TOP;
import static com.janela.mobile.Intents.EXTRA_POSITION;
import static com.janela.mobile.Intents.EXTRA_REPOSITORY;
import static com.janela.mobile.ResultCodes.RESOURCE_CHANGED;
import static com.janela.mobile.ui.repo.RepositoryPagerAdapter.ITEM_CODE;
...
import com.janela.mobile.core.repo.ForkRepositoryTask;
import com.janela.mobile.core.repo.RefreshRepositoryTask;
import com.janela.mobile.core.repo.RepositoryUtils;
import com.janela.mobile.core.repo.StarRepositoryTask;
import com.janela.mobile.core.repo.StarredRepositoryTask;
import com.janela.mobile.core.repo.UnstarRepositoryTask;
import com.janela.mobile.ui.TabPagerActivity;
import com.janela.mobile.ui.user.UriLauncherActivity;
...
public class RepositoryViewActivity extends TabPagerActivity<RepositoryPagerAdapter> {
    ...
    private void shareRepository() {
        ...
        if (TextUtils.isEmpty(repoUrl))
            repoUrl = "https://janela.com/" + repository.generateId();
