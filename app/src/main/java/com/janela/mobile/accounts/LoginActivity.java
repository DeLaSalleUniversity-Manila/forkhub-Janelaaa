 ...
 */
package com.janela.mobile.accounts;
...
import static com.janela.mobile.RequestCodes.OTP_CODE_ENTER;
import static com.janela.mobile.accounts.AccountConstants.ACCOUNT_TYPE;
import static com.janela.mobile.accounts.AccountConstants.PROVIDER_AUTHORITY;
import static com.janela.mobile.accounts.TwoFactorAuthActivity.PARAM_EXCEPTION;
import static com.janela.mobile.accounts.TwoFactorAuthClient.TWO_FACTOR_AUTH_TYPE_SMS;
...
import com.janela.kevinsawicki.wishlist.ViewFinder;
import com.janela.mobile.R;
import com.janela.mobile.persistence.AccountDataManager;
import com.janela.mobile.ui.LightProgressDialog;
import com.janela.mobile.ui.TextWatcherAdapter;
import com.janela.mobile.ui.roboactivities.RoboActionBarAccountAuthenticatorActivity;
