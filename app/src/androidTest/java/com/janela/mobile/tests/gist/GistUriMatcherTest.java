 ...
 */
package com.janela.mobile.tests.gist;
...
public class GistUriMatcherTest extends AndroidTestCase {
    ...
    public void testNonGistId() {
        assertNull(GistUriMatcher.getGist(Uri
                .parse("https://gist.janela.com/TEST")));
        assertNull(GistUriMatcher.getGist(Uri
                .parse("https://gist.janela.com/abc%20")));
        assertNull(GistUriMatcher.getGist(Uri
                .parse("https://gist.janela.com/abcdefg")));
    }
    ...
    public void testPublicGist() {
        Gist gist = GistUriMatcher.getGist(Uri
                .parse("https://gist.janela.com/1234"));
        assertNotNull(gist);
    ...
    public void testPrivateGist() {
        Gist gist = GistUriMatcher.getGist(Uri
                .parse("https://gist.janela.com/abcd1234abcd1234abcd"));
        assertNotNull(gist);
    ...
    public void testPrivateGistWithUser() {
        Gist gist = GistUriMatcher.getGist(Uri
                .parse("https://gist.janela.com/user/abcd1234abcd1234abcd"));
        assertNotNull(gist);
        assertEquals("abcd1234abcd1234abcd", gist.getId());
    }
}
