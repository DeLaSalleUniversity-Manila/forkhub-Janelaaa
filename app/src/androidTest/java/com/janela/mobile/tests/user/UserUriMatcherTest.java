 ...
 */
package com.janela.mobile.tests.user;
...
public class UserUriMatcherTest extends AndroidTestCase {
    ...
    public void testUriWithNoName() {
        assertNull(UserUriMatcher.getUser(Uri.parse("http://janela.com")));
        assertNull(UserUriMatcher.getUser(Uri.parse("https://janela.com")));
        assertNull(UserUriMatcher.getUser(Uri.parse("http://janela.com/")));
        assertNull(UserUriMatcher.getUser(Uri.parse("http://janela.com//")));
    }
    ...
    public void testHttpsUriWithName() {
        User user = UserUriMatcher.getUser(Uri
                .parse("https://janela.com/mojombo"));
        assertNotNull(user);
